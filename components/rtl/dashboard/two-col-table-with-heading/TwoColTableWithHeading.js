          ...
          <tr className={`border-b-[2px] border-[#dee2e6]`}>
            {data.headings.map((value, index) => {
              return (
                <td
                  key={value + 1}
                  className={` p-[.75rem] text-center font-[600] capitalize ${index == data.headings.length - 1 &&
              ...
              <td colSpan={5}>
                <div className="w-[100%] flex justify-center items-center h-[140px]">
                  <div className="w-[100%]">
                    ...
                    <h5 className=" text-[#212529] text-[20px] text-center pt-[5px]">
                  ...
                  >
                    {value.value.map((valu, inde) => {
                      return (
                        <td
                          key={valu + 1}
                          className={`align-top p-[.75rem] ${inde == 1 && pageName !== "dashboardHomePage"
                            ? "w-[30%]"
                            : ""
                            }`}
                        >
                    ...
                    {tableType && tableType == true ? (
                      <td className="p-[.75rem] flex gap-x-[5px] justify-end">
                        <div>
                          <Link href="/ar/dashboard/products/edit">
