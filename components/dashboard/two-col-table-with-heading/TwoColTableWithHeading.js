...
function TwoColTableWithHeading({ data, tableType, pageName }) {
              ...
              return (
                <td
                  ...
                  className={`fwr p-[.75rem] text-center font-[600] capitalize ${
                    index == data.headings.length - 1  && pageName !== "dashboardHomePage" ? "text-right" : ""
                  }`}
                >
                  {value}
                </td>
                      ...
                      return (
                        <td
                          ...
                          className={`align-top p-[.75rem] ${
                            ...
                            inde == 1 && pageName !== "dashboardHomePage" ? "w-[30%]" : ""
                          }`}
                        >
                          {valu}
                        </td>
